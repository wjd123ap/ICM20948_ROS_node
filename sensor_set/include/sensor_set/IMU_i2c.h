...
#define REG_ZA_OFFS_H 0x17
#define REG_ZA_OFFS_L 0x18
/* user bank 2 register */
#define REG_ADD_GYRO_SMPLRT_DIV 0x00
#define REG_ADD_GYRO_CONFIG_1   0x01

    #define REG_VAL_BIT_GYRO_DLPCFG_0   0x00
    #define REG_VAL_BIT_GYRO_DLPCFG_1   0x08 
    ...
    #define REG_VAL_BIT_GYRO_DLPCFG_5   0x28 /* bit[5:3] */
    #define REG_VAL_BIT_GYRO_DLPCFG_6   0x30 /* bit[5:3] */
    #define REG_VAL_BIT_GYRO_DLPCFG_7   0x38 /* bit[5:3] */
...
#define REG_ADD_ACCEL_CONFIG        0x14
    #define REG_VAL_BIT_ACCEL_DLPCFG_0  0x00
    #define REG_VAL_BIT_ACCEL_DLPCFG_1  0x08 /* bit[5:3] */
    ...
    #define REG_VAL_BIT_ACCEL_DLPCFG_5  0x28 /* bit[5:3] */
    #define REG_VAL_BIT_ACCEL_DLPCFG_6  0x30 /* bit[5:3] */
    #define REG_VAL_BIT_ACCEL_DLPCFG_7  0x38 /* bit[5:3] */
...
#define GFS_2000DPS_SCALE_FACTOR   16.4f
#define GFS_1000DPS_SCALE_FACTOR   32.8f
#define GFS_500DPS_SCALE_FACTOR    65.5f
...
#define AFS_2G_SCALE_FACTOR        16384.0f 
...
typedef struct imu_st_matrix_tag
{
    float s1;
    float s2;
    float s3;
...
typedef struct imu_st_scale_tag
{
  float s16X;
  float s16Y;
  float s16Z;
