...
void ICM20948::Init(void)
{
    ...
    I2C_WriteOneByte( I2C_ADD_ICM20948, REG_ADD_GYRO_SMPLRT_DIV, 0x03,fd_address);
    ...
    I2C_WriteOneByte( I2C_ADD_ICM20948, REG_ADD_ACCEL_SMPLRT_DIV_2,  0x03,fd_address);
...
void ICM20948::imuDataGet()
        ...
        MotionVal[0]=s32Gyro[0]/131.0f;
        MotionVal[1]=s32Gyro[1]/131.0f;
        MotionVal[2]=s32Gyro[2]/131.0f;
        MotionVal[3]=s32Accel[0];
        MotionVal[4]=s32Accel[1];
        MotionVal[5]=s32Accel[2];
